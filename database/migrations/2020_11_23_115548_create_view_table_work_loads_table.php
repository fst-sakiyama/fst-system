...
class CreateViewTableWorkLoadsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $sql = WorkTable::selectRaw('shiftTableId,
                          ...
                          ->toSql();
        DB::connection('mysql_two')->statement("CREATE VIEW view_table_work_loads AS ($sql)");
    }
    ...
    {
        DB::connection('mysql_two')->statement('DROP VIEW IF EXISTS view_table_work_loads');
    }
}
