...
@include('components.work_table.work_table_edit',['userId'=>$userId,'masterShifts'=>$masterShifts,'masterShift'=>$masterShift,'worktable'=>$workTable,'masterProjects'=>$masterProjects])
