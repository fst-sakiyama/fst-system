...
@include('components.work_table.work_table_edit',['nonOpe'=>$nonOpe,'userId'=>$userId,'shiftTableId'=>$shiftTableId,'masterShifts'=>$masterShifts,'masterShift'=>$masterShift,'worktable'=>$workTable,'teamProjects'=>$teamProjects,'workLoads'=>$workLoads,'before'=>$before])
