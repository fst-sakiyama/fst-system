  ...
  <div class="card-body">
    <div class="mt-3">
      ...
      <div class="form-group mt-5 form-inline">
        {{Form::button('削除',['class' => 'btn btn-danger btn-sm','onclick'=>"return confirm('本当に削除して良いですか？')",'wire:click'=>'onClick'])}}
      </div>
      ...
      <div class="form-group mt-5 form-inline">
        ...
        <div class="input-group col-md-6">
            <div class="custom-file">
                {{ Form::file('file',['class'=>'custom-file-input','id'=>'customFile','multiple'=>'multiple','name'=>'files[]','required']) }}
