...
<div class="contents">
  <div class="container mt-3">
    ...
    <div class="col">
      <div class="card">
        <h5 class="card-header">引き継ぎの作成</h5>
        <div class="card-body">
          <div class="mt-3">
            {{ Form::open(array('route' => array('take_over.update', $item->takeOverId), 'method' => 'PUT')) }}
            {{ Form::hidden('fstSystemProgressId',$item->projectId) }}
            ...
            <div class="form-group mt-3 form-inline">
              {{ Form::checkbox('wellKnown',\Carbon\Carbon::now(),false,['id'=>'check-id','class'=>'circle']) }}
              {{ Form::label('check-id','周知事項に入れる',['class'=>'form-check-label']) }}
            </div>
